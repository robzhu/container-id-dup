...
Click the **Deploy to AWS** button to create the CloudFormation stack in the AWS Management Console.

| Region | Launch Template |
| ------------ | ------------- | 
**Sydney** (ap-southeast-2) | [![Launch CodePipeline & EKS with CloudFormation](/images/deploy-to-aws.png)](https://console.aws.amazon.com/cloudformation/home?region=ap-southeast-2#/stacks/new?stackName=anzcd-codepipeline&templateURL=https://anz-container-day.s3-ap-southeast-2.amazonaws.com/container-day-templates/pipeline.yaml) 
**Virginia** (us-east-1) | [![Launch CodePipeline & EKS with CloudFormation](/images/deploy-to-aws.png)](https://console.aws.amazon.com/cloudformation/home?region=us-east-1#/stacks/new?stackName=anzcd-codepipeline&templateURL=https://anz-container-day.s3-ap-southeast-2.amazonaws.com/container-day-templates/pipeline.yaml)  
**Oregon** (us-west-2) | [![Launch CodePipeline & EKS with CloudFormation](/images/deploy-to-aws.png)](https://console.aws.amazon.com/cloudformation/home?region=us-west-2#/stacks/new?stackName=anzcd-codepipeline&templateURL=https://anz-container-day.s3-ap-southeast-2.amazonaws.com/container-day-templates/pipeline.yaml)  
